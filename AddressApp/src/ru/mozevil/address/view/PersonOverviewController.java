...
import ru.mozevil.address.util.DateUtil;
...
public class PersonOverviewController {
    ...
    /**
     * Конструктор.
     * Вызывается раньше метода initialize().
     */
    ...
    private void initialize() {
        ...
        // слушаем изменения выбора, и при изменении отображаем доп. инфо об адресате.
    ...
    public void setMainApp(MainApp mainApp) {
        ...
        // добавление в таблицу даных из наблюдаемого списка
    ...
    /**
     * Вызываем этот метод, когда пользователь тыкает по кнопке удаления.
     */
    @FXML
